...
enum class DeliveryStatusEnum(val CODE: String, val TITLE: String, val MSG: String, val BACKGROUND: Int) {
    NOT_REGISTERED("NOT_REGISTERED", "미등록", "배송 준비 중이에요", R.drawable.ic_inquiry_2depth_not_registered),
    INFORMATION_RECEIVED("INFORMATION_RECEIVED","배송정보 접수중", "배송 준비 중이에요", R.drawable.ic_inquiry_2depth_not_registered),

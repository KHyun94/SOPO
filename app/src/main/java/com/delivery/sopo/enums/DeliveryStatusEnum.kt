...
enum class DeliveryStatusEnum(val CODE: String, val TITLE: String, val MSG: String, val BACKGROUND: Int) {
    NOT_REGISTERED("NOT_REGISTERED", "미등록", "지금은 배송 준비 중", R.drawable.ic_inquiry_cardview_not_registered),
    ORPHANED("ORPHANED", "고아상태", "지금은 배송 준비 중", R.drawable.ic_inquiry_cardview_orphaned),
    INFORMATION_RECEIVED("INFORMATION_RECEIVED","배송정보 접수중", "지금은 배송 준비 중", R.drawable.ic_inquiry_cardview_not_registered),

...
class PopupMenuListAdapter(private var list: MutableList<InquiryMenuItem>):
        RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    {
        fun changeTimeCount(v: View, year: String)
    }

    class PopupMenuViewHolder(private val binding: InquiryListPopupWindowItemBinding):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder
    {
        ...
        return PopupMenuViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context),
                                                           R.layout.inquiry_list_popup_window_item,
                                                           parent, false))
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int)
    {
        ...
        if(holder !is PopupMenuViewHolder) return
        ...
        when(getViewType(position))
        {
            ...
            {
                holder.menuBinding.tvMenuText.text = inquiryMenuData.data + "년"
...
//                else
//                {
//                    holder.menuBinding.tvMenuText.setTextColor(
//                        ContextCompat.getColor(holder.menuBinding.root.context,
//                                               R.color.COLOR_GRAY_300))
//                }

                holder.menuBinding.constraintV.setOnClickListener {
                    historyPopUpItemOnclick.changeTimeCount(it, inquiryMenuData.data?:"2021")
                }

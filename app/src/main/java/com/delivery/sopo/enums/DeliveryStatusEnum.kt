...
enum class DeliveryStatusEnum(val CODE: String, val TITLE: String, val MSG: String, val BACKGROUND: Int) {
    ...
    INFORMATION_RECEIVED("information_received","배송정보 접수중", "아직 배송상품 정보가 없습니다.", R.drawable.ic_parcel_not_register),
    ...
    OUT_FOR_DELIVERY("out_for_delivery", "동네 도착", "집배원이 배달을 시작했습니다.", R.drawable.ic_parcl_out_of_delivery),

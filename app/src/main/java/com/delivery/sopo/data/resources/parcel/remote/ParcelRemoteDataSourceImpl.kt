        ...
        BaseService()
{
    override suspend fun registerParcel(parcelRegister: Parcel.Register): Int
    {
        ...
        return result.data ?: throw SOPOApiException.create(ErrorCode.PARCEL_NOT_FOUND)
    }
    ...
    override suspend fun fetchCarrierInfo(): List<Carrier.Info>{
        return apiCall { parcelService.fetchCarrierStatus() }.data ?: emptyList()
    }
}
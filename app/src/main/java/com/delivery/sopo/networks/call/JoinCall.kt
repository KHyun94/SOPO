...
object JoinCall : BaseService()
{
    ...
    suspend fun requestJoinBySelf(joinInfoByKakaoDTO: JoinInfoByKakaoDTO) : NetworkResult<APIResult<String?>>
    {
        return apiCall(call = { joinAPI.requestJoinBySelf(joinInfoByKakaoDTO) })
    }

    suspend fun requestJoinByKakao(joinInfoByKakaoDTO: JoinInfoByKakaoDTO) : NetworkResult<APIResult<String?>>
    {
